          ...
          <div className="flex justify-between">
            ...
            {handleDelete && (
              ...
              type="button"
                ...
                className="bg-red-500 cursor-pointer  text-white py-2 px-4 rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 foucs:ring-red-500 focus:ring-opacity-50"
              >
                Delete
              </button>
            )}
